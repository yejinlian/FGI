...
package deepthinking.parsii.eval;

import deepthinking.parsii.tokenizer.ParseError;
import deepthinking.parsii.tokenizer.ParseException;
import deepthinking.parsii.tokenizer.Token;
import deepthinking.parsii.tokenizer.Tokenizer;
...
public class Parser {
    ...
    static {
        ...
        registerFunction("log_", Functions.LOG_);
    }
